...
| Бэкенд              | Kotlin, Ktor, PostgreSQL, JWT                                              |
...
| Инфраструктура      | Gradle, GitHub Actions, Docker                                             |
...
- Для добавления новой модели:
  ...
  3. Импортируйте типы в React: `import type { Model } from './shared/kmp/'`.
