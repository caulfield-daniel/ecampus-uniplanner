...
// --- Фабрики фикстур ---
// plain-объекты приводятся к типам shared-моделей (as Task): сгенерированные
// объявления (web/src/shared/types/generated) соответствуют Kotlin-классам
// с методами copy/equals/toString, поэтому структурная проверка объектных
// литералов не проходит без каста (как в остальных тестах).
